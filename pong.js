...
function render(){
    //clear canvas
    drawRect(0, 0, canvas.width/2, canvas.height, colorPayer2);
    drawRect(canvas.width/2, 0, canvas.width, canvas.height, colorPayer1);
    //draw net
    drawNet();
    //draw obstacle
...
function gameUpdate(){
    ...
    if (com.score === roundsMax || user.score === roundsMax){
        game.running = false;
        user.color = colorPayer2;
        com.color = colorPayer1;
